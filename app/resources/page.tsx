          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredResources.map((resource, index) => {
              ...
              return (
                <div
                  key={resource.id}
                  className="bg-gray-50 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group"
                >
                  <div className="p-6">
                    {/* Icon and Type Badge */}
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span className="px-3 py-1 bg-secondary-100 text-secondary-700 rounded-full text-xs font-semibold uppercase">
                        {resource.type}
                      </span>
                    </div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-primary-700 hover:bg-primary-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105"
                    >
