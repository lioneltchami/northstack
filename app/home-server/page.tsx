    ...
    <>
            ...
            <table className="w-full bg-white dark:bg-gray-900 rounded-lg shadow-lg">
              <thead>
                <tr className="border-b-2 border-gray-200 dark:border-gray-700">
                  ...
                  <th className="p-4 text-center text-gray-900 dark:text-white font-bold">Commercial Cloud</th>
                  <th className="p-4 text-center text-gray-900 dark:text-white font-bold">Self-Hosted</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={index} className="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <td className={`p-4 text-center ${row.winner === 'cloud' ? 'bg-green-50 dark:bg-green-900/20' : ''}`}>
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">{row.cloud}</span>
                      </div>
                    </td>
                    <td className={`p-4 text-center ${row.winner === 'selfHosted' ? 'bg-green-50 dark:bg-green-900/20' : ''}`}>
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">{row.selfHosted}</span>
                      </div>
                    </td>
                  </tr>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold font-heading mb-2 text-primary-600 dark:text-primary-400">
                  {service.name}
                </h3>
      ...
      <section className="section-padding bg-white dark:bg-gray-900">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                ...
                <div className="text-2xl font-bold font-heading mb-2 text-gray-900 dark:text-white">
                  {hw.price}
                </div>
                <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">{hw.option}</h3>
          ...
          <div className="mt-12 max-w-3xl mx-auto bg-primary-50 dark:bg-primary-900/20 p-6 rounded-lg">
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {[
              ...
              <div key={index} className="flex gap-6 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="flex gap-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div className="flex-shrink-0">
