...
## Introduction
Story of a Calgary startup paying $15,000/month for AWS...

## Strategy 1: Right-Sizing EC2 Instances
- How to identify oversized instances
- CloudWatch metrics to monitor
- Step-by-step optimization process
- Real example: Saved $2,400/month

## Strategy 2: Leverage Reserved Instances and Savings Plans
- When to use RIs vs Savings Plans
- Coverage analysis
- Implementation roadmap
- Case study: 62% cost reduction

## Strategy 3: Optimize S3 Storage with Intelligent Tiering
- S3 storage classes explained
- Lifecycle policies setup
- Cost analysis examples
- Saved $1,200/month example

## Strategy 4: Use Lambda and Serverless Where Possible
- Identifying opportunities for serverless
- Migration strategy
